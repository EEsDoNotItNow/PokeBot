...
RUN cd /root/Downloads/Python-3.6.5/; ./configure --enable-optimizations; make -j8; make install
# RUN 
RUN /usr/local/bin/pip3 install discord python-dateutil numpy flake8 nose nose-timer pipenv
